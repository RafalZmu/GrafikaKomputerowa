...
public class SceneGraph extends JPanel {
	...
	// (DELETE THIS EXAMPLE)
		...
		private TransformedObject T1,T2,T3; // 3 trojkaty
		private TransformedObject L1,L2,L3; // 3 linie
		private TransformedObject  H1,H2,H3,H4,H5,H6; // wielokaty
	/**
	...
	private void createWorld() {
		...
		H1 = new TransformedObject(ngon);
		H1.setScale(0.3, 0.3).setTranslation(-0.889, -0.42);
		world.add(H1);		
		H2 = new TransformedObject(ngon);
		H2.setScale(0.3, 0.3).setTranslation(0.899, -1.189);
		world.add(H2);		
		H3 = new TransformedObject(ngon);
		H3.setScale(0.25, 0.25).setTranslation(-3, 1.825);
		world.add(H3);		
		H4 = new TransformedObject(ngon);
		H4.setScale(0.25, 0.25).setTranslation(-1.4, 1.18);
		world.add(H4);
		H5 = new TransformedObject(ngon);
		H5.setScale(0.2, 0.2).setTranslation(0.83, 2.07);
		world.add(H5);
		H6 = new TransformedObject(ngon);
		H6.setScale(0.2, 0.2).setTranslation(2.16, 1.52);
		world.add(H6);
		...
		T2.setScale(0.5,1).setTranslation(-2.25,0.5).setColor(new Color(128, 0, 128));//fiolet
		world.add(T2);
		T3 = new TransformedObject((filledTriangle));
		T3.setScale(0.5, 0.8).setTranslation(1.5, 1).setColor(Color.GREEN);
		world.add(T3);
		...
		L2.setRotation(-22.5).setScale(1.8, 0.1).setTranslation(-2.2, 1.50).setColor(Color.RED);
		world.add(L2);
		L3 = new TransformedObject(filledRect);
		L3.setRotation(-22.5).setScale(1.5, 0.08).setTranslation(1.5, 1.8).setColor(Color.RED);
		world.add(L3);
	...
	public void updateFrame() {
		frameNumber++;
		H1.setRotation(frameNumber);
		H2.setRotation(frameNumber);
		H3.setRotation(frameNumber);
		H4.setRotation(frameNumber);
		H5.setRotation(frameNumber);
		H6.setRotation(frameNumber);
	...
	//Rysowanie hexagonu
	private static SceneGraphNode ngon = new SceneGraphNode()
	{void doDraw(Graphics2D g){
		int n=15;
		double t=0;
		double k=(Math.PI*2)/n;
